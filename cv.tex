...
\hypersetup{                                              % Custom hyperlink settings
    ...
    pdftitle = {Karl Cronburg: Curriculum Vitae},         % PDF metadata - set within hypersetup
...
\rhead{\footnotesize Karl Cronburg: Curriculum Vitae (\mydate \today), Page \thepage} %header at the right
\headsep = 0.5cm
...
\rhead{\footnotesize Curriculum Vitae (\mydate \today)}
}
